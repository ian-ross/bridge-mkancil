...
proc ::combobox::Init {} {
	...
	set trc [$tmpWidget cget -troughcolor]
	destroy $tmpWidget
	...
	option add *Combobox.troughColor         $trc	widgetDefault
...
proc ::combobox::UpdateVisualAttributes {w} {
    ...
    $widgets(vsb)     configure -background $background -troughcolor $troughcolor
